        ...
        >
            <div className="flex">
                 ...
                 <div className="flex flex-col items-center mr-4 pt-1 w-6 flex-shrink-0 relative">
                     ...
                     {/* Vertical Line */}
                     <div className="w-0.5 bg-indigo-100 dark:bg-indigo-900/50 h-full absolute top-8 bottom-0 left-1/2 -translate-x-1/2"></div>
                 </div>
                 ...
                 <div className="flex-1 min-w-0">
                     <div
                        ...
                        className={`
                             ...
                             ${isDragging ? '' : 'sticky top-[48px] md:top-[56px] z-40 bg-[var(--bg-main)] py-2'}
                        `}
                     >
