        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="flex-1 overflow-y-auto min-h-0 -ml-1 pl-1 -mr-2 pr-2 scrollbar-hide">
                ...
                <div className="space-y-4 mb-8">
                    ...
                    {plan.mapLink && (
                        <a href={plan.mapLink} target={targetAttr} rel={relAttr} className="flex items-center p-3 rounded-lg bg-[var(--bg-color)] border border-[var(--card-border)] hover:bg-[var(--card-selected-bg)] hover:border-[var(--accent-blue)] transition-colors group">
                    ...
                    {plan.location && (
                        <a href={`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(plan.location)}&travelmode=transit`} target={targetAttr} rel={relAttr} className="flex items-center p-3 rounded-lg bg-[var(--bg-color)] border border-[var(--card-border)] hover:bg-[var(--card-selected-bg)] hover:border-[var(--accent-blue)] transition-colors group">
                            <div className="w-8 h-8 rounded-full bg-[var(--accent-blue)]/10 text-[var(--accent-blue)] group-hover:bg-[var(--accent-blue)] group-hover:text-white transition-colors flex items-center justify-center mr-3 flex-shrink-0">
